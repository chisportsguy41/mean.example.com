    ...
    xhr.onload = function(){
      ...
      table = `<div class="card">
        <div class="card-header clearfix">
          <h3 class="h3 float-left">Users</h3>
            ...
            <form id="editUser" class="card-body">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  class="form-control" value="${data.user.first_name}" required>
                </div>

                <div class="form-group col-md-6">
                  <label for="last_name">Last Name</label>
                  <input type="text" id="last_name" name="last_name"
                  class="form-control" value="${data.user.last_name}" required>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  class="form-control" value="${data.user.username}" required>
                </div>

                <div class="form-group col-md-6">
                  <label for="email">Email</label>
                  <input type="email" id="email" name="email"
                  class="form-control" value="${data.user.email}" required>
                </div>
              </div>
